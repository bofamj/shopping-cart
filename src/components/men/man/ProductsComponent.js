...
const BeautyProduct = ({ product }) => {
  ...
  const addToCart = (e, product) => {
    ...
    const isExsist = cart.find((item) => item.id === product.goods_id);
  ...
  return (
    <div className="card">
      <Link className="ditile-link" to={`/product/${product.goods_id}`}>
